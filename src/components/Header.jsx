            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <form onSubmit={handleSubmit} className="relative flex-grow md:mx-4">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-[#0000000d] bg-[#0000000d] focus:outline-none focus:border-black"
                    />
                    <svg
                    ...
                    <button className="absolute right-0 top-0 bottom-0 px-4 py-2 bg-black text-white font-semibold">
                        Search
                    </button>
                </form>
